...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070E1C] text-slate-100 relative overflow-hidden font-sans selection:bg-orange-500 selection:text-white">
      ...
      {/* 🟢 Top Navigation Bar (Sticky with Smooth Scroll Home Icon) */}
          ...
          <div className="flex items-center gap-3 text-center sm:text-left">
            ...
            <div>
              ...
              <h1 className="text-lg font-black tracking-tight text-white uppercase">
                <span className="text-orange-400 drop-shadow-[0_0_12px_rgba(249,115,22,0.6)]">EV</span>ISIONARY SOLUTIONS INDIA
              </h1>
